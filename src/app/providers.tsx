    ...
    <ClerkProvider
      appearance={{
        elements: {
          ...
          formButtonPrimary: '!bg-primary !border-border !text-primary-foreground hover:!bg-primary/90',
          ...
          userButtonOuterIdentifier: 'text-sm font-medium truncate group-data-[collapsible=icon]:!hidden',
